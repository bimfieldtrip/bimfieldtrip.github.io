...
const GUIDE_SPOTS = [
  ...
  { id: "gs-existing-bund", tab: "see", category: "SEE", area: "NANJING EAST · BUND", name: "The Bund", name_zh: "外滩", address: "", hours: "", note: "상하이를 대표하는 강변 산책로 · 야경 명소.", image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/6/64/Shanghai_skyline_from_the_bund.jpg/1280px-Shanghai_skyline_from_the_bund.jpg", image_alt: "Pudong skyline seen from the Bund, Shanghai", image_source_url: "https://commons.wikimedia.org/wiki/File:Shanghai_skyline_from_the_bund.jpg", image_credit: "", image_license: "CC0" },
  { id: "gs-existing-nanjing-east-road", tab: "see", category: "SEE", area: "NANJING EAST · BUND", name: "Nanjing East Road", name_zh: "南京东路", address: "", hours: "", note: "와이탄과 이어지는 대표 쇼핑가." },
  { id: "gs-existing-peoples-square", tab: "see", category: "SEE", area: "OTHER", name: "People's Square", name_zh: "人民广场", address: "", hours: "", note: "상하이 도심 중앙 광장 · 지하철 환승 거점." },
  { id: "gs-existing-oriental-pearl", tab: "see", category: "SEE", area: "LUJIAZUI", name: "Oriental Pearl Tower", name_zh: "东方明珠", address: "", hours: "", note: "푸동 스카이라인의 상징적인 전망 타워.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/ShanghaiPearlTower.jpg/960px-ShanghaiPearlTower.jpg", image_alt: "Oriental Pearl Tower, Shanghai", image_source_url: "https://commons.wikimedia.org/wiki/File:ShanghaiPearlTower.jpg", image_credit: "", image_license: "Public Domain" },
  { id: "gs-existing-lujiazui", tab: "see", category: "SEE", area: "LUJIAZUI", name: "Lujiazui", name_zh: "陆家嘴", address: "", hours: "", note: "상하이 금융 중심지 · 초고층 스카이라인 지역." },
  { id: "gs-existing-shanghai-tower", tab: "see", category: "SEE", area: "LUJIAZUI", name: "Shanghai Tower", name_zh: "上海中心大厦", address: "", hours: "", note: "중국에서 가장 높은 초고층 빌딩." },
  { id: "gs-existing-xintiandi", tab: "see", category: "SEE", area: "XINTIANDI", name: "Xintiandi", name_zh: "新天地", address: "", hours: "", note: "스쿠먼(石库门) 골목을 재개발한 상업지구." },
  { id: "gs-existing-tianzifang", tab: "see", category: "SEE", area: "XINTIANDI", name: "Tianzifang", name_zh: "田子坊", address: "", hours: "", note: "좁은 골목 사이 공방·카페·편집숍이 모인 구역." },
  { id: "gs-existing-yuyuan", tab: "see", category: "SEE", area: "OTHER", name: "Yuyuan Garden", name_zh: "豫园", address: "", hours: "", note: "전통 정원과 주변 상가(예원상성)를 함께 둘러볼 수 있음.", image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/e/e9/Yu_Garden_1.jpg/1280px-Yu_Garden_1.jpg", image_alt: "Yu Garden, Shanghai", image_source_url: "https://commons.wikimedia.org/wiki/File:Yu_Garden_1.jpg", image_credit: "", image_license: "Public Domain" },
  { id: "gs-existing-jingan-temple", tab: "see", category: "SEE", area: "NANJING WEST · JING'AN", name: "Jing'an Temple", name_zh: "静安寺", address: "", hours: "", note: "난징시루 인근의 대표 사찰.", image: "https://thumb.wikimedia.org/wikipedia/commons/thumb/e/ea/Jing%27an_temple.JPG/1280px-Jing%27an_temple.JPG", image_alt: "Jing'an Temple, Shanghai", image_source_url: "https://commons.wikimedia.org/wiki/File:Jing%27an_temple.JPG", image_credit: "Photo: J. Patrick Fischer", image_license: "CC BY-SA 3.0" },
  { id: "gs-existing-korean-provisional-govt", tab: "see", category: "SEE", area: "XINTIANDI", name: "Site of the Provisional Government of the Republic of Korea", name_zh: "大韩民国临时政府旧址", address: "", hours: "", note: "신천지 인근의 대한민국 임시정부 관련 유적." },
  { id: "gs-existing-longhua", tab: "see", category: "SEE", area: "OTHER", name: "Longhua Temple / Longhua Pagoda", name_zh: "龙华寺 / 龙华塔", address: "", hours: "", note: "상하이에서 가장 오래된 사찰·탑 중 하나." },
  { id: "gs-existing-m50", tab: "see", category: "SEE", area: "OTHER", name: "M50", name_zh: "M50", address: "", hours: "", note: "옛 방직공장을 개조한 현대미술 갤러리 단지." },
  { id: "gs-existing-pudong-art-museum", tab: "see", category: "SEE", area: "LUJIAZUI", name: "Pudong Museum of Art", name_zh: "浦东美术馆", address: "", hours: "", note: "와이탄 건너편 강변에 위치한 미술관." },
  { id: "gs-existing-xujiahui-library", tab: "see", category: "SEE", area: "YONGKANG · XUHUI", name: "Xujiahui Library", name_zh: "徐家汇书院", address: "", hours: "", note: "徐家汇 지역의 대표 도서관·복합문화공간." },
  { id: "gs-existing-xujiahui-cathedral", tab: "see", category: "SEE", area: "YONGKANG · XUHUI", name: "Xujiahui Cathedral (St. Ignatius Cathedral)", name_zh: "徐家汇天主教堂", address: "", hours: "", note: "쉬자후이의 대표 성당 건축물." },
  { id: "gs-existing-zhujiajiao", tab: "see", category: "SEE", area: "OTHER", name: "Zhujiajiao Water Town", name_zh: "朱家角", address: "", hours: "", note: "상하이 외곽의 수향(水乡) 고진(古镇)." },
  { id: "gs-existing-wuzhen", tab: "see", category: "SEE", area: "OTHER", name: "Wuzhen Water Town", name_zh: "乌镇", address: "", hours: "", note: "장쑤·저장 지역의 대표 수향 고진." },
  { id: "gs-existing-panlong-tiandi", tab: "see", category: "SEE", area: "OTHER", name: "Panlong Tiandi", name_zh: "蟠龙天地", address: "", hours: "", note: "장강 삼각주 전통 마을을 재생한 복합공간." },
];
...
GUIDE_SPOTS.forEach((s) => {
  ...
  s.image_context = s.image_context || ""; // 예: "AREA VIEW" — 매장 자체 사진이 아닌 지역 사진임을 카드에 표시
});
